						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="post" action="student/save" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-3"> 学生编号 </label>

										<div class="col-sm-9">
											<input type="text" name="stunum" value="${stu.stunum}" id="form-field-3" placeholder="Stunum" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
